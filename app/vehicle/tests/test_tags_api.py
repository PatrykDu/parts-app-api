...
class PrivateTagsApiTests(TestCase):
    ...
    def test_retrieve_tags(self):
        ...
        Tag.objects.create(user=self.user, name='Motorcycle')
    ...
    def test_tags_limited_to_user(self):
        ...
        Tag.objects.create(user=user2, name='Car')
        tag = Tag.objects.create(user=self.user, name='Motorcycle')
    ...
    def test_update_tag(self):
        """Test updating a tag."""
        tag = Tag.objects.create(user=self.user, name='Modern')

        payload = {'name': 'Classic'}
    ...
    def test_delete_tag(self):
        """Test deleting a tag."""
        tag = Tag.objects.create(user=self.user, name='Electric')
    ...
    def test_filter_tags_assigned_to_vehicles(self):
        """Test listing tags to those assigned to vehicles."""
    ...
    def test_filtered_tags_unique(self):
        ...
        tag = Tag.objects.create(user=self.user, name='classic')
        Tag.objects.create(user=self.user, name='modern')
